...
9. **기업 사실 검증**: 기업·브랜드 정보는 웹 검색 또는 JD에서 확인된 사실만 사용하세요. 모회사·자회사·인수 기업의 사업을 혼동하지 말고, 확인되지 않은 사업·제품·고객·조직 구조는 작성하지 마세요. 검색 결과가 부족하면 기업 정보는 추정하지 말고 직무와 JD 중심의 일반적인 시뮬레이션으로 만드세요.`;
