...
9. **기업 사실 검증**: 기업·브랜드 정보는 공식 홈페이지·서비스 페이지·뉴스룸·보도자료·IR 자료 또는 JD에서 확인된 사실만 사용하세요. 채용 플랫폼은 직무 요건을 보완하는 용도로만 사용하고, 사업·제품·고객·최근 이슈를 단정하는 근거로 사용하지 마세요. 모회사·자회사·인수 기업의 사업을 혼동하지 말고, 확인되지 않은 사업·제품·고객·조직 구조·최근 이슈는 작성하지 마세요. 검색 결과가 부족하면 기업 정보는 추정하지 말고 직무와 JD 중심의 일반적인 시뮬레이션으로 만드세요.`;
