...
export const TRIAL_SINGLE_ORIGINAL_PRICE = 4990;
export const TRIAL_SINGLE_DISCOUNT_PERCENT = Math.round(
  (1 - TRIAL_PLAN_PRICES.single / TRIAL_SINGLE_ORIGINAL_PRICE) * 100,
); // 4,990원 → 990원 = 80%
