  ...
  if (size === "large") {
    return (
      <button
        ...
        className="flex h-12 w-full items-center justify-center gap-3 rounded-xl border border-[#dadce0] bg-white px-4 font-[Roboto,Arial,sans-serif] text-base font-medium text-[#202124] shadow-none transition-colors hover:bg-[#f8fafd] disabled:cursor-wait disabled:opacity-60"
      >
        ...
        <span>{isRedirecting ? "Google 로그인 연결 중..." : "Google 계정으로 계속하기"}</span>
      </button>
    );
  }
